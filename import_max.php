						...
						while ($zip_entry = zip_read($zip))
						{
							try
							{
								...
								if ($new_filesize > "499")
								{
									...
									$ud = " UPDATE advert SET lge='2', productfeed='0' WHERE network='$network_id' AND networks_id='$mer_id' ";
								...
								else if ($new_filesize == "0")
								{
									...
									$ud = " UPDATE advert SET productfeed='0' WHERE network='$network_id' AND networks_id='$mer_id' ";
									$udr = mysqli_query($conn,$ud);																
								}
								else
								{
									$ud = " UPDATE advert SET last_update='$timestamp' WHERE network='$network_id' AND networks_id='$mer_id' ";
									$udr = mysqli_query($conn,$ud);	
